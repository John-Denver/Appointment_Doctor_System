                            ...
                            <tr>
                                <td>
                                    ...
                                    <form action="schedule.php" method="post" style="display: flex">
                                        ...
                                        <input type="Submit" value="Search" class="login-btn btn-primary btn" style="background-color: #fe6e00; padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;">
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows == 0) {
                                        echo '<tr>
                                                    ...
                                                    <a class="non-style-link" href="schedule.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px; background-color: #fe6e00;">&nbsp; Channel a Doctor &nbsp;</font></button>
                                                    </a>
                                                    </center>
                                                    <br><br><br><br>
                                                    </td>
